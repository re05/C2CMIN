...
ALTER TABLE public.listings
  ADD CONSTRAINT IF NOT EXISTS listings_seller_id_fkey
  FOREIGN KEY (seller_id) REFERENCES public.users(id) ON DELETE CASCADE;

-- listing_comments: 出品・ユーザー
ALTER TABLE public.listing_comments
  ADD CONSTRAINT IF NOT EXISTS listing_comments_listing_id_fkey
  FOREIGN KEY (listing_id) REFERENCES public.listings(id) ON DELETE CASCADE;

ALTER TABLE public.listing_comments
  ADD CONSTRAINT IF NOT EXISTS listing_comments_author_id_fkey
  FOREIGN KEY (author_id) REFERENCES public.users(id) ON DELETE CASCADE;

-- orders: 出品・購入者
ALTER TABLE public.orders
  ADD CONSTRAINT IF NOT EXISTS orders_listing_id_fkey
  FOREIGN KEY (listing_id) REFERENCES public.listings(id) ON DELETE CASCADE;

ALTER TABLE public.orders
  ADD CONSTRAINT IF NOT EXISTS orders_buyer_id_fkey
  FOREIGN KEY (buyer_id) REFERENCES public.users(id) ON DELETE CASCADE;

-- order_messages: 取引・送信者
ALTER TABLE public.order_messages
  ADD CONSTRAINT IF NOT EXISTS order_messages_order_id_fkey
  FOREIGN KEY (order_id) REFERENCES public.orders(id) ON DELETE CASCADE;

ALTER TABLE public.order_messages
  ADD CONSTRAINT IF NOT EXISTS order_messages_sender_id_fkey
